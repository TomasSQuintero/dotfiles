...
-- capaz que con lo del colours_override no hace falta, pero por las dudas
-- para cambiar el color del resaltado
-- usamos esta config para /home/tom/.local/share/nvim/site/pack/core/opt/everforest-nvim/lua/everforest/colours.lua
--
